...
<p>The general flow of our smart parking system algorithm is fairly straightforward:
...
4.	If the centroid lies in the empty parking box made by admin. Then, the slot is occupied.</p>
